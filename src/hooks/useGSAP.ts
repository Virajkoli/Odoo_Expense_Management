...
export const animateElements = (selector: string, animation: string, delay = 0) => {
  ...
  switch (animation) {
    ...
    case 'slideInLeft':
      gsap.fromTo(
        elements,
        { opacity: 0, x: -100 },
        { opacity: 1, x: 0, duration: 0.8, delay, stagger: 0.1, ease: 'power3.out' }
      )
      break
    case 'slideInRight':
      gsap.fromTo(
    ...
    case 'scaleIn':
      gsap.fromTo(
        elements,
        { opacity: 0, scale: 0.8 },
        { opacity: 1, scale: 1, duration: 0.6, delay, stagger: 0.1, ease: 'power3.out' }
      )
      break
  }
}